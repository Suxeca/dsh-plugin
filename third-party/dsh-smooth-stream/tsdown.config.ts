 ...
 *
 * Local fix 2026-08-19: teleprompterGlide clampLag — glide lag transform is
 * clamped to one line height so a mid-stream line wrap (CJK + long paths)
 * cannot visually overlap adjacent rows.
 */
